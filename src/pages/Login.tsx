...
export default function Login() {
  ...
  const { login, isLoading, error, clearError, isAuthenticated, initialize, isInitialized } = useAuthStore();
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        ...
        <div className="p-8 space-y-6 bg-white/[0.07] backdrop-blur-xl rounded-2xl border border-white/[0.12] shadow-[0_8px_60px_-12px_rgba(0,0,0,0.6)]">
          <div className="text-center">
            ...
            <p className="mt-1.5 text-sm text-white/50">Sign in to continue building</p>
          </div>
